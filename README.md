...
>
> Dies ist ein Fork von [nuke-build/nuke](https://github.com/nuke-build/nuke). Veröffentlicht wird unter dem `fglang.`-Präfix auf NuGet.org, um Namens-Kollisionen mit dem Original zu vermeiden.
>
